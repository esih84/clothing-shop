...
urlpatterns = [
    ...
    path('profile_explore/<int:user_id>/', profile_explore, name='profile_explore'),
    ...
    path('save/<int:id>/', save_post, name='save_post'),
    path('save_library/', save_n, name='save'),
    ...
    path('settings/', privat, name='settings'),
